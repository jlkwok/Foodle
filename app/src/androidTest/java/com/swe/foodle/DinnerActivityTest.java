...
/**
 * Test the functionality of the Dinner Activity and MealCategorySearch/Type, RecipeAdapter classes implicitly.
 */
...
public class DinnerActivityTest {
    ...
    /**
     * Tests the dinner page functionality.
     */
    @Test
    public void dinnerActivityTest() {
    ...
    /**
     * Helps with testing dinner activity page, helps test that components are displayed correctly.
