...
/**
 * Test the functionality of the Dessert Activity and MealCategorySearch/Type, RecipeAdapter classes implicitly.
 */
...
public class DessertActivityTest {
    ...
    /**
     * Tests the dessert page functionality.
     */
    @Test
    public void dessertActivityTest() {
        // open side menu bar
    ...
    /**
     * Helps with testing dessert activity page, helps test that components are displayed correctly.
